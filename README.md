...
- `EDA.sql`: a query for data exploration
- `Data_Visualization.sql`: a query for data visualization in Tableau
...
I thank Bopith (https://github.com/bopith/) for inspiring me with this project idea.
